      ...
      <Row>
        ...
        <Col md={8} className="d-flex justify-content-center align-items-center pl-md-2">
          <Card.Body>
            ...
            <Card.Text className="h4 text-muted mb-3">I’m a Holistic Nutritionist, Professional Dancer, and Dance Instructor/Choreographer.</Card.Text>
            ...
            <Link to="/contact" className="btn btn-lg btn-info">Let's chat</Link>
          </Card.Body>
        </Col>
      </Row>
    </Card>
